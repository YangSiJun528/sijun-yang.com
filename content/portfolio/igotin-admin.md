...
Instagram 계정 관리에 대해 궁금하다면 [IGOTIN 서비스 소개 페이지](@/portfolio/igotin.md)를 확인해 주세요.
...
<figcaption><em>HTML로 재구성한 예시 화면, 회사의 자료를 사용하지 않았습니다.</em><br>단계별 상태와 오류 로그를 확인, 작업 재시도 가능</figcaption>
</figure>
