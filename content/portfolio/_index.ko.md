...
[LinkedIn](https://www.linkedin.com/company/igotin/posts/?feedView=all) \| [서비스 소개](@/portfolio/igotin.ko.md)<br>
백엔드 개발자<br>
...
IGOTIN은 학생이 작성한 자기소개를 학교별 [Instagram 계정](@/portfolio/igotin.ko.md)에 자동 게시하는 기능을 제공했습니다.<br>
...
[관리자 화면 전후 비교 예시](@/portfolio/igotin-admin.ko.md)
