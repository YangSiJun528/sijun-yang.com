...
<h1 class="main-title">양시준</h1>
<p class="resume-role">백엔드 엔지니어</p>
</div>
<ul class="resume-contact" aria-label="연락처">
<li><strong>이메일:</strong> <a href="mailto:yangsijun5528@gmail.com">yangsijun5528@gmail.com</a></li>
<!-- 실제 제출용 이력서에서는 실제 전화번호로 교체하고 tel: 링크를 추가할 것. -->
<li><strong>전화번호:</strong> 010-XXXX-XXXX</li>
<li><strong>GitHub:</strong> <a href="https://github.com/YangSiJun528" rel="me">YangSiJun528</a></li>
</ul>
</header>
...
<li>Java/Kotlin, Spring Boot, PostgreSQL을 활용한 백엔드 서비스 개발 및 AWS 클라우드 인프라 운영</li>
<li>로그와 지표를 통한 성능 분석 및 운영 문제 해결</li>
<li>SQLP와 실무 경험을 바탕으로 한 DB 설계 및 쿼리 튜닝</li>
<li>AI 코딩 도구를 활용한 개발과 정적 검사, 자동화 테스트, CI 기반 품질 관리 환경 구축</li>
</ul>
...
<ul class="resume-skills resume-summary-list">
<li>Java, Kotlin, SQL, Python, TypeScript, Rust</li>
<li>Spring Boot, JPA, PostgreSQL, Redis</li>
<li>AWS, GitHub, JetBrains IDEs</li>
</ul>
...
<div class="resume-main">광주소프트웨어마이스터고 입학 지원 서비스</div>
</li>
</ul>
...
<p class="resume-oss-summary"><a href="https://github.com/YangSiJun528/my-oss-contributions">총 프로젝트 15+, 기여 50+</a></p>

<ul class="resume-list">
<li>
<div class="resume-row resume-row--compact">
<span class="resume-main"><strong><a href="https://github.com/search?q=repo%3Aspring-io%2Finitializr+author%3AYangSiJun528&type=pullrequests">Spring Initializr</a></strong> (팀 외 기여 2위)</span>
